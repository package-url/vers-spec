...
# VERS Type Definition: npm

- **Type Name:** npm versioning
- **Description:** npm versioning version ranges.
- **Schema ID:** `https://packageurl.org/vers-types/npm-definition.json`
