...
- **CUDF** defines a generic range notation for integer
  version numbers from the sequence of versions for universal
  dependency resolution. https://www.mancoosi.org/cudf/primer/
- **OSV** is an "Open source vulnerability DB and triage service." It
  ...
  comparators for use with a package "ecosystem" and version range
